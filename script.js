...
["MONTANA", "TOMATO SAUCE, HAM & MOZZARELLA CHEESE", [230, 500, 680, 1230, 1620]], 
["HAWAIIAN", "TOMATO SAUCE, HAM, PINEAPPLE & MOZZARELLA CHEESE", [240, 510, 710, 1270, 1660]], 
["ZURICH", "TOMATO SAUCE, GROUND BEEF, MUSHROOM, ONION, BELLPEPPER & MOZZARELLA CHEESE", [250, 520, 720, 1280, 1670]], 
["TESSINO", "TOMATO SAUCE, MUSHROOM, BELLPEPPER, ONION, MOZZARELLA CHEESE & PEPPERONI", [260, 540, 740, 1290, 1710]], 
["SWISSO ITALIANO", "TOMATO SAUCE, GROUND BEEF, HAM, SALAMI, ONION, BELLPEPPER & MOZZARELLA CHEESE", [270, 550, 750, 1290, 1710]], 
["BERN", "TOMATO SAUCE, GROUNDBEEF, MUSHROOM, ONION & MOZZARELLA CHEESE", [250, 520, 720, 1280, 1670]], 
["CALZONE", "TOMATO SAUCE, GROUNDBEEF, SALAMI, MUSHROOM & MOZZARELLA CHEESE", [250, 520, 720, 12800, 1670]], 
["SCHWEINS", "TOMATO SAUCE, GROUNDBEEF, BACON, TOMATO, ONION & MOZZARELLA CHEESE", [260, 540, 740, 1290, 1710]], 
["VEGETABLES", "TOMATO SAUCE, MUSHROOM, TOMATO, BELLPEPPER, ONION, MOZZARELLA CHEESE & BLACK OLIVES", [230, 500, 680, 1230, 1620]], 
["EL TUNA", "TOMATO SAUCE, TUNA, ONION, BELLPEPPER & MOZZARELLA CHEESE", [240, 510, 710, 1280, 1670]], 
["SUPREMO", "TAMATO SAUCE, GROUNDBEEF, SAUSAGE, SALAMI, ONION, BELLPEPPER, MOZZARELLA CHEESE & BLACK OLIVES", [280, 590, 800, 1300, 1730]], 
["GREENOZ SAUSAGE", "TOMATO SAUCE, GROUNDBEEF, SAUSAGE, BACON, BELLPEPPER, ONION & MOZZARELLA CHEESE", [280, 590, 800, 1300, 1730]], 
["PEPPERONI", "TOMATO SAUCE, GROUNDBEEF, ONION, BELLPEPPER, MOZZARELLA CHEESE & PEPPERONI", [270, 550, 750, 1290, 1710]], 
["MAMAMIA", "TOMATO CHEESE, GROUNDBEEF, SAUSAGE, HAM, SALAMI, BACON, ONION, BELLPEPPER, MOZZARELLA CHEESE, PEPPERONI & BLACK OLIVES", [290, 600, 820, 1330, 1750]]];
...
grid.innerHTML=flavors.map((f,i)=>`<article class="pizza" data-i="${i}">
  <h3>${f[0]}</h3>
  <p>${f[1]}</p>
  <div class="price-list">
    ${sizes.map((s,j)=>`<div class="price-row"><span>${s[0]}</span><strong>${money(f[2][j])}</strong></div>`).join("")}
  </div>
</article>`).join("");
